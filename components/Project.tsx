    ...
    >
      ...
      >
        <section className="group max-w-2xl relative rounded-lg sm:h-[20rem] border-black/5 border bg-gray-100 mx-10 md:mx-auto overflow-hidden">
          ...
          <Image
            className="absolute hidden sm:block h-full w-full top-8 -right-[23rem] rounded-t-lg shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:translate-x-3 group-hover:translate-y-3 group-hover:rotate-[-3deg]"
            src={imageUrl}
            alt="project image"
            quality={100}
          />
