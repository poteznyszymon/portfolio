    ...
    >
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 max-w-3xl mx-auto px-10 md:px-0">
        {skills.map((skill, index) => (
          <motion.li
            className="px-5 py-3 bg-white/70  hover:bg-white transition-colors duration-500 backdrop-blur-[0.5rem] border text-center border-black/5 rounded-md shadow-sm"
            key={index}
